...
function App() {
    ...
    const getUser = async () => {
        const response = await axios.get(`http://localhost:3000/getUser/${address}`);
    ...
    return (
        <div>
            ...
            <div>
                <input type="text" placeholder="Address to Lookup" value={address} onChange={e => setAddress(e.target.value)} />
